...
public class TODO {
	 ...
	 * t0.muokkaaKaikki("Tee harkkaan vielä testit", "Kotikone", aika0, "Ei muuta sitten");
	 * t0.toString() === "0#Tee harkkaan vielä testit#Kotikone#14:45:00#Ei muuta sitten";
	 * t0.getId() === 0;
	 * t0.getOtsikko() === "Tee harkkaan vielä testit";
	 ...
	 * t0.muokkaaPaikka("Missä vain");
	 * t0.getPaikka() === "Missä vain";
	 * t0.muokkaaAika(new Time(15,55,00));
	 * t0.getAika().toString() === "14:55:00";
	 * t0.muokkaaLisaTietoa("Keksitään tekemistä");
	 * t0.getLisaTietoa() === "Keksitään tekemistä";
	 * </pre> 
	 */
	public TODO(int id) {
		this.id = id;
